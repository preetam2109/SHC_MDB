...
export class StockReportComponent {
  ...
  constructor(
    ...
    this.dataSource = new MatTableDataSource<StockReport>([]);
  ...
  // }
    ...
    this.spinner.show();
    this.api.getStockReport(this.facid,0,category).subscribe(
      (res) => {
        // Add serial numbers to the data
...
// console.log(JSON.stringify(res))
  ...
  exportToPDF() {
    ...
    const header='Current Stock Report'
    ...
    const columns = [
      ...
      { title: "Current Stock", dataKey: "readyForIssue" },
